...
class KinoGerResolver(ResolveUrl):
    name = 'KinoGer'
    domains = [
        'kinoger.re', 'shiid4u.upn.one', 'moflix.upns.xyz', 'player.upn.one', 'disneycdn.net', 'png.strp2p.com',
    ...
    pattern = r'(?://|\.)((?:kinoger|wasuytm|ultrastream|(?:shiid4u|player)\.upn|(?:moflix|cimanow|embedplay)\.(?:upns|rpmplay)|' \
              ...
              r'w1tv|(?:flixfilmesonline\.|filma365\.|moviehax\.|png\.)?strp2p|flimmer\.rpmvip|(?:t1|kinoger)\.p2pplay|' \
