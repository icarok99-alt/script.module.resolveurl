...
class ByseResolver(ResolveUrl):
    name = 'Byse'
    domains = [
        'f16px.com', 'g9r6.com', 'bysesayeveum.com', 'bysetayico.com', 'bysevepoin.com', 'bysezejataos.com',
    ...
    pattern = r'(?://|\.)((?:filemoon|cinegrab|moonmov|kerapoxy|furher|1azayf9w|81u6xl9d|f16px|g9r6|' \
